(ns pedestal-component.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro pedestal-component-templates
  []
  ;; Extract the 'hello' template from the template file pedestal-component.html.
  ...
  ;;
  ;; app/src/pedestal_component/rendering.cljs
  ;;
  ...
  {:pedestal-component-page (dtfn (tnodes "pedestal-component.html" "hello") #{:id})})
